...
var (
	...
	fd_Params_ubi_pool              protoreflect.FieldDescriptor
...
func init() {
	...
	fd_Params_ubi_pool = md_Params.Fields().ByName("ubi_pool")
...
func (x *fastReflection_Params) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.UbiPool != "" {
		value := protoreflect.ValueOfString(x.UbiPool)
		if !f(fd_Params_ubi_pool, value) {
			return
		}
	}
...
func (x *fastReflection_Params) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.distribution.v1beta1.Params.ubi_pool":
		return x.UbiPool != ""
...
func (x *fastReflection_Params) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.distribution.v1beta1.Params.ubi_pool":
		x.UbiPool = value.Interface().(string)
	case "cosmos.distribution.v1beta1.Params.base_proposer_reward":
...
func (x *fastReflection_Params) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.distribution.v1beta1.Params.ubi_pool":
		panic(fmt.Errorf("field ubi_pool of message cosmos.distribution.v1beta1.Params is not mutable"))
	case "cosmos.distribution.v1beta1.Params.base_proposer_reward":
...
func (x *fastReflection_Params) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.UbiPool) > 0 {
			i -= len(x.UbiPool)
			copy(dAtA[i:], x.UbiPool)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.UbiPool)))
			i--
			dAtA[i] = 0xa
		}
		if input.Buf != nil {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 1:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field UbiPool", wireType)
				}
				...
				x.UbiPool = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 2:
				if wireType != 2 {
...
var (
	...
	fd_FeePool_ubi_pool protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_distribution_v1beta1_distribution_proto_init()
	md_FeePool = File_cosmos_distribution_v1beta1_distribution_proto.Messages().ByName("FeePool")
	fd_FeePool_ubi_pool = md_FeePool.Fields().ByName("ubi_pool")
}
...
func (x *fastReflection_FeePool) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.UbiPool) != 0 {
		value := protoreflect.ValueOfList(&_FeePool_1_list{list: &x.UbiPool})
		if !f(fd_FeePool_ubi_pool, value) {
			return
		}
	}
}
...
func (x *fastReflection_FeePool) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.distribution.v1beta1.FeePool.ubi_pool":
		return len(x.UbiPool) != 0
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_FeePool) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.distribution.v1beta1.FeePool.ubi_pool":
		...
		listValue := &_FeePool_1_list{list: &x.UbiPool}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.distribution.v1beta1.FeePool"))
...
func (x *fastReflection_FeePool) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.distribution.v1beta1.FeePool.ubi_pool":
		if x.UbiPool == nil {
			x.UbiPool = []*v1beta1.DecCoin{}
		}
		value := &_FeePool_1_list{list: &x.UbiPool}
		return protoreflect.ValueOfList(value)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.distribution.v1beta1.FeePool"))
...
func (x *fastReflection_FeePool) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.UbiPool) > 0 {
			for iNdEx := len(x.UbiPool) - 1; iNdEx >= 0; iNdEx-- {
				encoded, err := options.Marshal(x.UbiPool[iNdEx])
				if err != nil {
					return protoiface.MarshalOutput{
						NoUnkeyedLiterals: input.NoUnkeyedLiterals,
						Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 1:
				...
				x.UbiPool = append(x.UbiPool, &v1beta1.DecCoin{})
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.UbiPool[len(x.UbiPool)-1]); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			default:
...
type Params struct {
	...
	UbiPool string `protobuf:"bytes,1,opt,name=ubi_pool,json=ubiPool,proto3" json:"ubi_pool,omitempty"`
...
func (x *Params) GetUbiPool() string {
	if x != nil {
		return x.UbiPool
	}
	return ""
...
type FeePool struct {
	...
	UbiPool []*v1beta1.DecCoin `protobuf:"bytes,1,rep,name=ubi_pool,json=ubiPool,proto3" json:"ubi_pool,omitempty"`
}
...
func (x *FeePool) GetUbiPool() []*v1beta1.DecCoin {
	if x != nil {
		return x.UbiPool
	}
	return nil
...
var file_cosmos_distribution_v1beta1_distribution_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x90, 0x03, 0x0a, 0x06, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0x51, 0x0a, 0x08,
	0x75, 0x62, 0x69, 0x5f, 0x70, 0x6f, 0x6f, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x36,
	...
	0x63, 0xa8, 0xe7, 0xb0, 0x2a, 0x01, 0x52, 0x07, 0x75, 0x62, 0x69, 0x50, 0x6f, 0x6f, 0x6c, 0x12,
	...
	0x61, 0x77, 0x41, 0x64, 0x64, 0x72, 0x45, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x3a, 0x25, 0x8a,
	...
	0x22, 0x8f, 0x01, 0x0a, 0x13, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x53, 0x6c,
	...
	0x69, 0x6f, 0x64, 0x12, 0x4d, 0x0a, 0x08, 0x66, 0x72, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x18,
	...
	0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x44, 0x65, 0x63, 0x52, 0x08, 0x66, 0x72, 0x61, 0x63, 0x74, 0x69,
	0x6f, 0x6e, 0x22, 0x89, 0x01, 0x0a, 0x14, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72,
	0x53, 0x6c, 0x61, 0x73, 0x68, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x12, 0x71, 0x0a, 0x16, 0x76,
	0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x5f, 0x73, 0x6c, 0x61, 0x73, 0x68, 0x5f, 0x65,
	0x76, 0x65, 0x6e, 0x74, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x30, 0x2e, 0x63, 0x6f,
	...
	0xde, 0x1f, 0x00, 0xa8, 0xe7, 0xb0, 0x2a, 0x01, 0x52, 0x14, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61,
	0x74, 0x6f, 0x72, 0x53, 0x6c, 0x61, 0x73, 0x68, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x22, 0x7c,
	0x0a, 0x07, 0x46, 0x65, 0x65, 0x50, 0x6f, 0x6f, 0x6c, 0x12, 0x71, 0x0a, 0x08, 0x75, 0x62, 0x69,
	...
	0xb0, 0x2a, 0x01, 0x52, 0x07, 0x75, 0x62, 0x69, 0x50, 0x6f, 0x6f, 0x6c, 0x22, 0xe3, 0x01, 0x0a,
	...
	0x5b, 0x0a, 0x0d, 0x72, 0x65, 0x77, 0x61, 0x72, 0x64, 0x73, 0x5f, 0x73, 0x74, 0x61, 0x6b, 0x65,
	...
	0x72, 0x65, 0x77, 0x61, 0x72, 0x64, 0x73, 0x53, 0x74, 0x61, 0x6b, 0x65, 0x12, 0x44, 0x0a, 0x06,
	0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x42, 0x2c, 0xea, 0xde,
	0x1f, 0x0f, 0x63, 0x72, 0x65, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x68, 0x65, 0x69, 0x67, 0x68,
	0x74, 0xa2, 0xe7, 0xb0, 0x2a, 0x0f, 0x63, 0x72, 0x65, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x68,
	0x65, 0x69, 0x67, 0x68, 0x74, 0xa8, 0xe7, 0xb0, 0x2a, 0x01, 0x52, 0x06, 0x68, 0x65, 0x69, 0x67,
	0x68, 0x74, 0x22, 0xe1, 0x01, 0x0a, 0x19, 0x44, 0x65, 0x6c, 0x65, 0x67, 0x61, 0x74, 0x69, 0x6f,
	...
	0x3a, 0x04, 0x88, 0xa0, 0x1f, 0x00, 0x42, 0x88, 0x02, 0x0a, 0x1f, 0x63, 0x6f, 0x6d, 0x2e, 0x63,
	0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x64, 0x69, 0x73, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x69,
	0x6f, 0x6e, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x42, 0x11, 0x44, 0x69, 0x73, 0x74,
...
var file_cosmos_distribution_v1beta1_distribution_proto_depIdxs = []int32{
	...
	10, // 5: cosmos.distribution.v1beta1.FeePool.ubi_pool:type_name -> cosmos.base.v1beta1.DecCoin
