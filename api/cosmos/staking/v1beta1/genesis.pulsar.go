...
var (
	...
	fd_GenesisState_token_types           protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_GenesisState_token_types = md_GenesisState.Fields().ByName("token_types")
}
...
func (x *fastReflection_GenesisState) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.TokenTypes != nil {
		value := protoreflect.ValueOfMessage(x.TokenTypes.ProtoReflect())
		if !f(fd_GenesisState_token_types, value) {
			return
		}
	}
}
...
func (x *fastReflection_GenesisState) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.staking.v1beta1.GenesisState.token_types":
		return x.TokenTypes != nil
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_GenesisState) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "cosmos.staking.v1beta1.GenesisState.token_types":
		x.TokenTypes = value.Message().Interface().(*TokenTypes)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v1beta1.GenesisState"))
		}
...
func (x *fastReflection_GenesisState) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.staking.v1beta1.GenesisState.token_types":
		if x.TokenTypes == nil {
			x.TokenTypes = new(TokenTypes)
		}
		return protoreflect.ValueOfMessage(x.TokenTypes.ProtoReflect())
	case "cosmos.staking.v1beta1.GenesisState.last_total_power":
...
func (x *fastReflection_GenesisState) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.TokenTypes != nil {
			encoded, err := options.Marshal(x.TokenTypes)
			if err != nil {
				return protoiface.MarshalOutput{
					NoUnkeyedLiterals: input.NoUnkeyedLiterals,
					Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 10:
				...
				if x.TokenTypes == nil {
					x.TokenTypes = &TokenTypes{}
				}
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.TokenTypes); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			default:
...
type GenesisState struct {
	...
	TokenTypes *TokenTypes `protobuf:"bytes,10,opt,name=token_types,json=tokenTypes,proto3" json:"token_types,omitempty"`
}
...
func (x *GenesisState) GetTokenTypes() *TokenTypes {
	if x != nil {
		return x.TokenTypes
	}
	return nil
...
var file_cosmos_staking_v1beta1_genesis_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xad, 0x06, 0x0a, 0x0c, 0x47, 0x65, 0x6e,
	...
	0x07, 0x70, 0x65, 0x72, 0x69, 0x6f, 0x64, 0x73, 0x12, 0x4e, 0x0a, 0x0b, 0x74, 0x6f, 0x6b, 0x65,
	0x6e, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x22, 0x2e,
	...
	0x73, 0x42, 0x09, 0xc8, 0xde, 0x1f, 0x00, 0xa8, 0xe7, 0xb0, 0x2a, 0x01, 0x52, 0x0a, 0x74, 0x6f,
	0x6b, 0x65, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x73, 0x22, 0x68, 0x0a, 0x12, 0x4c, 0x61, 0x73, 0x74,
...
var file_cosmos_staking_v1beta1_genesis_proto_goTypes = []interface{}{
	...
	(*Periods)(nil),             // 7: cosmos.staking.v1beta1.Periods
	(*TokenTypes)(nil),          // 8: cosmos.staking.v1beta1.TokenTypes
}
var file_cosmos_staking_v1beta1_genesis_proto_depIdxs = []int32{
	...
	7, // 6: cosmos.staking.v1beta1.GenesisState.periods:type_name -> cosmos.staking.v1beta1.Periods
	8, // 7: cosmos.staking.v1beta1.GenesisState.token_types:type_name -> cosmos.staking.v1beta1.TokenTypes
