...
// FundUbi allows an account to directly fund the ubi.
// The amount is first added to the distribution module account and then directly
// added to the pool. An error is returned if the amount cannot be sent to the
// module account.
func (k Keeper) FundUbi(ctx context.Context, amount sdk.Coins, sender sdk.AccAddress) error {
	...
	feePool.Ubi = feePool.Ubi.Add(sdk.NewDecCoinsFromCoins(amount...)...)
