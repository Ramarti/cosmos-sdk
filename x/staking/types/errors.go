...
var (
	...
	ErrMinSelfDelegationBelowMinDelegation    = errors.Register(ModuleName, 46, "validator's minimum self delegation must be greater than or equal to minimum delegation")
	ErrDelegationBelowMinimum                 = errors.Register(ModuleName, 47, "delegation amount must be greater than or equal to minimum delegation")
	ErrNoPeriodDelegation                     = errors.Register(ModuleName, 48, "period delegation does not exist")
	ErrNotEnoughPeriodDelegationShares        = errors.Register(ModuleName, 49, "not enough period delegation shares")
	ErrNotEnoughDelegationRewardsShares       = errors.Register(ModuleName, 50, "not enough delegation rewards shares")
