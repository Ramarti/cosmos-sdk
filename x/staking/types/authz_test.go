...
func TestAuthzAuthorizations(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			&coin100,
			stakingtypes.NewMsgUndelegate(delAddr.String(), val1.String(), stakingtypes.FlexiblePeriodDelegationID, coin100),
			false,
			true,
			nil,
		},
		{
			...
			stakingtypes.AuthorizationType_AUTHORIZATION_TYPE_UNDELEGATE,
			&coin100,
			stakingtypes.NewMsgUndelegate(delAddr.String(), val1.String(), stakingtypes.FlexiblePeriodDelegationID, coin50),
			false,
			false,
			&stakingtypes.StakeAuthorization{
				Validators: &stakingtypes.StakeAuthorization_AllowList{
		...
		},
		{
			...
			stakingtypes.AuthorizationType_AUTHORIZATION_TYPE_UNDELEGATE,
			&coin100,
			stakingtypes.NewMsgUndelegate(delAddr.String(), val3.String(), stakingtypes.FlexiblePeriodDelegationID, coin100),
			true,
			false,
			nil,
		},
		{
			...
			stakingtypes.AuthorizationType_AUTHORIZATION_TYPE_UNDELEGATE,
			nil,
			stakingtypes.NewMsgUndelegate(delAddr.String(), val2.String(), stakingtypes.FlexiblePeriodDelegationID, coin100),
			false,
			false,
			&stakingtypes.StakeAuthorization{
				Validators: &stakingtypes.StakeAuthorization_AllowList{
		...
		},
		{
			...
			stakingtypes.AuthorizationType_AUTHORIZATION_TYPE_REDELEGATE,
			&coin100,
			stakingtypes.NewMsgBeginRedelegate(delAddr.String(), val1.String(), val1.String(), stakingtypes.FlexiblePeriodDelegationID, coin50),
			false,
			false,
			&stakingtypes.StakeAuthorization{
				Validators: &stakingtypes.StakeAuthorization_AllowList{
		...
		},
		{
			...
			stakingtypes.AuthorizationType_AUTHORIZATION_TYPE_REDELEGATE,
			&coin100,
			stakingtypes.NewMsgBeginRedelegate(delAddr.String(), val3.String(), val3.String(), stakingtypes.FlexiblePeriodDelegationID, coin100),
			true,
			false,
			nil,
		},
		{
			...
			stakingtypes.AuthorizationType_AUTHORIZATION_TYPE_REDELEGATE,
			nil,
			stakingtypes.NewMsgBeginRedelegate(delAddr.String(), val2.String(), val2.String(), stakingtypes.FlexiblePeriodDelegationID, coin100),
			false,
			false,
			&stakingtypes.StakeAuthorization{
				Validators: &stakingtypes.StakeAuthorization_AllowList{
		...
		},
		{
			...
			stakingtypes.AuthorizationType_AUTHORIZATION_TYPE_REDELEGATE,
			&coin100,
			stakingtypes.NewMsgBeginRedelegate(delAddr.String(), val1.String(), val1.String(), stakingtypes.FlexiblePeriodDelegationID, coin100),
			true,
			false,
			nil,
		},
